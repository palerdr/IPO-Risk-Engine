...
> Historical research note. Use the [current project guide](PROJECT_GUIDE.md) for verified capabilities and known limits. This checkout does not reproduce the historical metrics.
